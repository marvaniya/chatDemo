                ...
                <div className="right_header">
                    <div className="profile_div">
                        <div className="profile_name">
                            <img src="public/assets/profile.svg" className="profile_icon" />
                                    ...
                                    user ? (
                                        <>
                                            <button onClick={userLogout} className="logout_btn">
                                                <img src="public/assets/profile.svg" className="sign_icon" /> Logout
                                            </button></>
                                    ) : (
                                        <Link to="/signin" className="logout_btn">
                                            <img src="public/assets/profile.svg" className="sign_icon" /> Sign In
                                        </Link>
                                    )
                                }
                    ...
                    <img src="public/assets/hamburger.svg" onClick={toggleSidebar} className="toggle_btn" />
                </div>
            </div>
