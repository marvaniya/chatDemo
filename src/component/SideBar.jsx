        ...
        <div className="sidebar" style={{ left: isOpen ? "0" : "-300px" }}>
            <Link to="/">
                <div className="sidebar-brand">
                     <img src="public/assets/robot.png" className="logo"/>
            ...
            <div>
                <div className="menu-section">
                    ...
                    >
                        <img src="public/assets/edit.svg" className="sidebar_icons" alt="folder" />
                        <span>New chat</span>
                    </Link>
                    <Link
                        to="#"
                        className="sidebar-item"
                    >
                        <img src="public/assets/folder.svg" className="sidebar_icons" alt="folder" />
                    ...
                    <div className={`sidebar-expandable ${expandedPanels.includes("Chats") ? "active" : ""}`}>
                        ...
                        >
                            <img src="public/assets/folder.svg" className="sidebar_icons" alt="folder" />
                            <span>Chats</span>
                            <img src="public/assets/arrow.svg" className="chevron-icon" alt="arrow" />
                        </div>
